  ...
  es: {
    ...
    pages: {
      ...
      obligations: {
        ...
        cadenceEveryLabel: "Cada cuantos meses",
        cadenceEveryMonth: "1 mes",
        cadenceEveryNMonths: (n: number) => `Cada ${n} meses`,
  ...
  en: {
    ...
    pages: {
      ...
      obligations: {
        ...
        cadenceEveryLabel: "Every N months",
        cadenceEveryMonth: "1 month",
        cadenceEveryNMonths: (n: number) => `Every ${n} months`,
